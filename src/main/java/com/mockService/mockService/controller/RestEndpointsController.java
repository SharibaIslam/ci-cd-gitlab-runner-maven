...
public class RestEndpointsController {
 ...
 /*Robi recharge timeout*/
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/pranRFL/oauth/token/**",produces="application/json",consumes = "application/x-www-form-urlencoded")
    public String pranRFLGetToken() {
        /*Map<String, Object> props = new HashMap<>();
        props.put(SOAPMessage.WRITE_XML_DECLARATION, "true");*/
        return pranRFlRechargeService.getToken();
    }

    @RequestMapping(method = RequestMethod.POST, value = "/pranRFL/api/SendTopUp/**",produces="application/json",consumes = "application/x-www-form-urlencoded")
    public String pranRFLEnquiry() {
        ...
        //fail response
        return pranRFlRechargeService.getPranRFLFailResponse();
    }
    ...
    @RequestMapping(method = RequestMethod.POST,value = "/doDebitTransaction",produces = "application/xml",consumes = "application/xml")
    public String cityBankCashIn(){
        return cityBankService.doDebitTxn();
    }

    @RequestMapping(method = RequestMethod.POST,value = "/doCreditTransaction",produces = "application/xml",consumes = "application/xml")
    public String cityBankCashOut(){
        return cityBankService.doCreditTxn();
    }

    @RequestMapping(method = RequestMethod.GET,value = "/ecomm2/ClientHandler",consumes = "application/json",produces = "application/json")
    public String getRocketRedirectURL(@RequestParam(value = "card_type",required = true)String card_type,
                                       @RequestParam(value = "trans_id",required = true)String trans_id) {
        return rocketCheckoutService.redirectURL(card_type, trans_id);
    }
